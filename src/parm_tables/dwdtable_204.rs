use super::Parm;
pub const DWD_204: [Parm; 256] = [
    /* 0 */ Parm("var0", "undefined"),
    /* 1 */
    Parm(
        "p RMS fg-a",
        "pressure RMS-error first guess - analysis [Pa]",
    ),
    /* 2 */
    Parm(
        "p RMS ia-a",
        "pressure RMS-error initialised analysis - analysis [Pa]",
    ),
    /* 3 */ Parm("u RMS fg-a", "u RMS-error first guess - analysis [m/s]"),
    /* 4 */
    Parm(
        "u RMS ia-a",
        "u RMS-error initialised analysis - analysis [m/s]",
    ),
    /* 5 */ Parm("v RMS fg-a", "v RMS-error first guess - analysis [m/s]"),
    /* 6 */
    Parm(
        "v RMS ia-a",
        "v RMS-error initialised analysis - analysis [m/s]",
    ),
    /* 7 */
    Parm(
        "fi E fg-a",
        "geopotential RMS-error first guess - analysis [(m**2)/(s**2)]",
    ),
    /* 8 */
    Parm(
        "fi E ia-a",
        "geopotential RMS-error init. analysis - analysis [(m**2)/(s**2)]",
    ),
    /* 9 */
    Parm(
        "rh E fg-a",
        "relative humidity RMS-error first guess - analysis [1]",
    ),
    /* 10 */
    Parm(
        "rh E ia-a",
        "rel. hum. RMS-error init. analysis - analysis [1]",
    ),
    /* 11 */
    Parm(
        "t RMS fg-a",
        "temperature RMS-error first guess - analysis [K]",
    ),
    /* 12 */
    Parm(
        "t RMS ia-a",
        "temperature RMS-error init. analysis - analysis [K]",
    ),
    /* 13 */ Parm("om E fg-a", "omega RMS-error first guess - analysis [m/s]"),
    /* 14 */
    Parm(
        "om E ia-a",
        "omega RMS-error initialised analysis - analysis [m/s]",
    ),
    /* 15 */
    Parm(
        "E fg-a KE",
        "kinetic energy RMS-error first guess - analysis [(m**2)/(s**2)]",
    ),
    /* 16 */
    Parm(
        "E ig-a KE",
        "kinetic energy RMS-error init. analysis [(m**2)/(s**2)]",
    ),
    ...
    /* 131 */ Parm("RR20", "probability of total precipitation > 20mm [1]"),
    /* 132 */ Parm("RR50", "probability of total precipitation > 50mm [1]"),
    /* 133 */ Parm("RR100", "probability of total precipitation > 100mm [1]"),
    ...
    /* 141 */ Parm("FF10", "probability of maximum wind speed > 10m/s [1]"),
    /* 142 */ Parm("FF15", "probability of maximum wind speed > 15m/s [1]"),
    /* 143 */ Parm("FF20", "probability of maximum wind speed > 20m/s [1]"),
