...
pub const ECMWF_190: [Parm; 256] = [
    ...
    Parm(
        "SSRD",
        "Downward surface solar radiation [W m**-2 s (W m**-2 for monthly means)]",
    ),
    /* 170 */ Parm("CAP", "Field capacity [(0 - 1)]"),
    /* 171 */ Parm("WILT", "Wilting point [(0 - 1)]"),
    /* 172 */ Parm("LSM", "Land-sea mask [(0 - 1)]"),
    /* 173 */ Parm("SR", "Roughness length [(0 - 1)]"),
    /* 174 */ Parm("AL", "Albedo [(0 - 1)]"),
    /* 175 */
    Parm(
        "STRD",
        "Downward surface long wave radiation [W m**-2 s (W m**-2 for monthly means)]",
    ),
    /* 176 */
    Parm(
        "SSR",
        "Surface net solar radiation [W m**-2 s (W m**-2 for monthly means)]",
    ),
    /* 177 */
    Parm(
        "STR",
        "Surface net long wave radiation [W m**-2 s (W m**-2 for monthly means)]",
    ),
    /* 178 */
    Parm(
        "TSR",
        "Top net solar radiation [W m**-2 s (W m**-2 for monthly means)]",
    ),
    /* 179 */
    Parm(
        "TTR",
        "Top net long wave radiation [W m**-2 s (W m**-2 for monthly means)]",
    ),
    /* 180 */ Parm("var180", "undefined"),
    /* 181 */ Parm("var181", "undefined"),
    /* 182 */ Parm("E", "Evaporation [m (m s**-1 for monthly means)]"),
    ...
    /* 201 */ Parm("MX2T", "Maximum 2 metre temperature [K]"),
    /* 202 */ Parm("MN2T", "Minimum 2 metre temperature [K]"),
    ...
    /* 228 */ Parm("TP", "Total precipitation [m (m s**-1 for monthly means)]"),
    /* 229 */ Parm("TSM", "Total soil moisture [m**3 m**-3]"),
