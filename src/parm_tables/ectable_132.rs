...
pub const ECMWF_132: [Parm; 256] = [
    ...
    /* 49 */ Parm("10FGI", "10 metre wind gust index [(-1 to 1)]"),
    ...
    /* 144 */ Parm("SFI", "Snowfall index [(-1 to 1)]"),
    ...
    /* 165 */ Parm("10WSI", "10 metre speed index [(-1 to 1)]"),
    /* 166 */ Parm("var166", "undefined"),
    /* 167 */ Parm("2TI", "2 metre temperature index [(-1 to 1)]"),
    ...
    Parm(
        "MAXSWHI",
        "Maximum of significant wave height index [(-1 to 1)]",
    ),
    /* 201 */ Parm("MX2TI", "Maximum temperature at 2 metres index [(-1 to 1)]"),
    /* 202 */ Parm("MN2TI", "Minimum temperature at 2 metres index [(-1 to 1)]"),
    ...
    /* 228 */ Parm("TPI", "Total precipitation index [(-1 to 1)]"),
