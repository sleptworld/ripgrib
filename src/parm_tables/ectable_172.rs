...
pub const ECMWF_172: [Parm; 256] = [
    ...
    /* 44 */ Parm("SNOE", "Snow evaporation m of water s**-1"),
    /* 45 */ Parm("SNOM", "Snow melt m of water s**-1"),
    /* 46 */ Parm("var46", "undefined"),
    /* 47 */ Parm("var47", "undefined"),
    /* 48 */ Parm("MSS", "magnitude of surface stress N m**-2"),
    /* 49 */ Parm("var49", "undefined"),
    /* 50 */ Parm("", "Large-scale precipitation fraction -"),
    ...
    /* 142 */ Parm("LSP", "Large scale precipitation m s**-1"),
    /* 143 */ Parm("CP", "Convective precipitation m s**-1"),
    /* 144 */
    Parm(
        "SF",
        "Snowfall (convective + stratiform) m of water equivalent s**-1",
    ),
    ...
    /* 148 */ Parm("SNR", "Surface net radiation W m**-2"),
    /* 149 */ Parm("var149", "undefined"),
    /* 150 */ Parm("var150", "undefined"),
    /* 151 */ Parm("var151", "undefined"),
    /* 152 */ Parm("var152", "undefined"),
    /* 153 */ Parm("SWHR", "Short-wave heating rate	K s**-1"),
    /* 154 */ Parm("LWHR", "Long-wave heating rate K s**-1"),
    ...
    /* 169 */ Parm("SSRD", "Surface solar radiation downwards W m**-2"),
    ...
    /* 175 */ Parm("STRD", "Surface thermal radiation downwards W m**-2"),
    ...
    /* 180 */ Parm("EWSS", "East-West surface stress N m**-2"),
    /* 181 */ Parm("NSSS", "North-South surface stress N m**-2"),
    /* 182 */ Parm("E", "Evaporation m of water s**-1"),
    ...
    /* 189 */ Parm("SUND", "Sunshine duration"),
    ...
    Parm(
        "LGWS",
        "Latitudinal component of gravity wave stress N m**-2",
    ),
    /* 196 */
    Parm(
        "MGWS",
    ...
    /* 197 */ Parm("GWD", "Gravity wave dissipation W m**-2"),
    ...
    /* 205 */ Parm("RO", "Runoff m s**-1"),
    /* 206 */ Parm("var206", "undefined"),
    /* 207 */ Parm("var207", "undefined"),
    /* 208 */ Parm("TSRC", "Top net solar radiation, clear sky 	W m**-2"),
    /* 209 */ Parm("TTRC", "Top net thermal radiation, clear sky 	W m**-2"),
    /* 210 */ Parm("SSRC", "Surface net solar radiation, clear sky W m**-2"),
    /* 211 */ Parm("STRC", "Surface net thermal radiation, clear sky W m**-2"),
    /* 212 */ Parm("SI", "Solar insolation W m**-2"),
    ...
    /* 228 */ Parm("TP", "Total precipitation m s**-1"),
    ...
    /* 239 */ Parm("CSF", "Convective snowfall m of water equivalent s**-1"),
    /* 240 */ Parm("LSF", "Large-scale snowfall 	m of water equivalent s**-1"),
