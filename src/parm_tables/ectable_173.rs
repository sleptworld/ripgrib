...
pub const ECMWF_173:[Parm;256] = [
      ...
      /* 44 */ Parm("var44", "Snow evaporation anomaly [m of water s**-1]"),
      /* 45 */ Parm("var45", "Snowmelt anomaly [m of water s**-1]"),
      /* 46 */ Parm("var46", "undefined"),
      /* 47 */ Parm("var47", "undefined"),
      /* 48 */ Parm("var48", "Magnitude of surface stress anomaly [N m**-2]"),
      /* 49 */ Parm("var49", "undefined"),
      /* 50 */ Parm("var50", "Large-scale precipitation fraction anomaly []"),
      ...
      /* 142 */ Parm("var142", "Stratiform precipitation (Large-scale precipitation) anomaly [m s**-1]"),
      /* 143 */ Parm("var143", "Convective precipitation anomaly [m s**-1]"),
      /* 144 */ Parm("SFARA", "Snowfall (convective + stratiform) anomalous rate of accumulation [m of water equivalent s**-1]"),
      /* 145 */ Parm("var145", "Boundary layer dissipation anomaly [W m**-2]"),
      /* 146 */ Parm("var146", "Surface sensible heat flux anomaly [W m**-2]"),
      /* 147 */ Parm("var147", "Surface latent heat flux anomaly [W m**-2]"),
      /* 148 */ Parm("var148", "undefined"),
      /* 149 */ Parm("var149", "Surface net radiation anomaly [W m**-2]"),
      /* 150 */ Parm("var150", "undefined"),
      /* 151 */ Parm("var151", "undefined"),
      /* 152 */ Parm("var152", "undefined"),
      /* 153 */ Parm("var153", "Short-wave heating rate anomaly [K s**-1]"),
      /* 154 */ Parm("var154", "Long-wave heating rate anomaly [K s**-1]"),
      ...
      /* 169 */ Parm("var169", "Surface solar radiation downwards anomaly [W m**-2]"),
      ...
      /* 175 */ Parm("var175", "Surface thermal radiation downwards anomaly [W m**-2]"),
      /* 176 */ Parm("var176", "Surface solar radiation anomaly [W m**-2]"),
      /* 177 */ Parm("var177", "Surface thermal radiation anomaly [W m**-2]"),
      /* 178 */ Parm("var178", "Top solar radiation anomaly [W m**-2]"),
      /* 179 */ Parm("var179", "Top thermal radiation anomaly [W m**-2]"),
      /* 180 */ Parm("var180", "East-West surface stress anomaly [N m**-2]"),
      /* 181 */ Parm("var181", "North-South surface stress anomaly [N m**-2]"),
      /* 182 */ Parm("var182", "Evaporation anomaly [m of water s**-1]"),
      ...
      /* 189 */ Parm("SUNDARA", "Sunshine duration anomalous rate of accumulation [dimensionless]"),
      ...
      /* 195 */ Parm("var195", "Latitudinal component of gravity wave stress anomaly [N m**-2]"),
      /* 196 */ Parm("var196", "Meridional component of gravity wave stress anomaly [N m**-2]"),
      /* 197 */ Parm("var197", "Gravity wave dissipation anomaly [W m**-2]"),
      ...
      /* 205 */ Parm("var205", "Runoff anomaly [m s**-1]"),
      /* 206 */ Parm("var206", "undefined"),
      /* 207 */ Parm("var207", "undefined"),
      /* 208 */ Parm("var208", "Top net solar radiation, clear sky anomaly [W m**-2]"),
      /* 209 */ Parm("var209", "Top net thermal radiation, clear sky anomaly [W m**-2]"),
      /* 210 */ Parm("var210", "Surface net solar radiation, clear sky anomaly [W m**-2]"),
      /* 211 */ Parm("var211", "Surface net thermal radiation, clear sky anomaly [W m**-2]"),
      /* 212 */ Parm("var212", "Solar insolation anomaly [W m**-2 s**-1]"),
      ...
      /* 228 */ Parm("TPARA", "Total precipitation anomalous rate of accumulation [m s**-1]"),
      ...
      /* 239 */ Parm("var239", "Convective snowfall anomaly [m of water equivalent s**-1]"),
      /* 240 */ Parm("var240", "Large-scale snowfall anomaly [m of water equivalent s**-1]"),
