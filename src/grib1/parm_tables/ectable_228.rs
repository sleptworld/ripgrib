use super::Parm;
pub const ECMWF_228: [Parm; 256] = [
    /* 0 */ Parm("var0", "undefined"),
    /* 1 */ Parm("CIN", "Convective inhibition [J kg**-1]"),
    /* 2 */ Parm("OROG", "Orography [m]"),
    /* 3 */ Parm("ZUST", "Friction velocity [m s**-1]"),
    /* 4 */ Parm("MEAN2T", "Mean temperature at 2 metres [K]"),
    /* 5 */ Parm("MEAN10WS", "Mean of 10 metre wind speed [m s**-1]"),
    /* 6 */ Parm("MEANTCC", "Mean total cloud cover [(0 - 1)]"),
    /* 7 */ Parm("DL", "Lake depth [m]"),
    /* 8 */ Parm("LMLT", "Lake mix-layer temperature [K]"),
    /* 9 */ Parm("LMLD", "Lake mix-layer depth [m]"),
    /* 10 */ Parm("LBLT", "Lake bottom temperature [K]"),
    /* 11 */ Parm("LTLT", "Lake total layer temperature [K]"),
    /* 12 */ Parm("LSHF", "Lake shape factor [dimensionless]"),
    /* 13 */ Parm("LICT", "Lake ice temperature [K]"),
    /* 14 */ Parm("LICD", "Lake ice depth [m]"),
    /* 15 */
    Parm(
        "DNDZN",
        "Minimum vertical gradient of refractivity inside trapping layer [m**-1]",
    ),
    /* 16 */
    Parm(
        "DNDZA",
        "Mean vertical gradient of refractivity inside trapping layer [m**-1]",
    ),
    /* 17 */ Parm("DCTB", "Duct base height [m]"),
    /* 18 */ Parm("TPLB", "Trapping layer base height [m]"),
    /* 19 */ Parm("TPLT", "Trapping layer top height [m]"),
    ...
    /* 39 */ Parm("SM", "Soil Moisture [kg m**-3]"),
    ...
    /* 131 */ Parm("U10N", "Neutral wind at 10 m x-component [m s**-1]"),
    /* 132 */ Parm("V10N", "Neutral wind at 10 m y-component [m s**-1]"),
    /* 133 */ Parm("var133", "undefined"),
    /* 134 */
    Parm(
        "VTNOWD",
        "V-tendency from non-orographic wave drag [m s**-2]",
    ),
    /* 135 */ Parm("var135", "undefined"),
    /* 136 */
    Parm(
        "UTNOWD",
        "U-tendency from non-orographic wave drag [m s**-2]",
    ),
    /* 137 */ Parm("var137", "undefined"),
    /* 138 */ Parm("var138", "undefined"),
    /* 139 */ Parm("ST", "Soil Temperature [K]"),
    /* 140 */ Parm("var140", "undefined"),
    /* 141 */ Parm("SD", "Snow Depth water equivalent [m]"),
    /* 142 */ Parm("var142", "undefined"),
    /* 143 */ Parm("var143", "undefined"),
    /* 144 */ Parm("SF", "Snow Fall water equivalent [kg m**-2]"),
    ...
    /* 164 */ Parm("TCC", "Total Cloud Cover [%]"),
    ...
    /* 170 */ Parm("CAP", "Field capacity [kg m**-3]"),
    /* 171 */ Parm("WILT", "Wilting point [kg m**-3]"),
    ...
    /* 228 */ Parm("TP", "Total Precipitation [kg m**-2]"),
