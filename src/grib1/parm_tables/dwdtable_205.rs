use super::Parm;
pub const DWD_205: [Parm; 256] = [
    /* 0 */ Parm("var0", "undefined"),
    /* 1 */ Parm("SYNME5", "METEOSAT-5 mit Instrument MVIRI [1]"),
    /* 2 */ Parm("SYNME6", "METEOSAT-6 mit Instrument MVIRI [1]"),
    /* 3 */ Parm("SYNME7", "METEOSAT-7 mit Instrument MVIRI [1]"),
    /* 4 */ Parm("SYNMSG", "MSG mit Instrument SEVIRI [1]"),
