...
pub const ECMWF_174: [Parm; 256] = [
    ...
    /* 6 */ Parm("var6", "Total soil moisture [m]"),
    /* 7 */ Parm("var7", "undefined"),
    /* 8 */ Parm("SRO", "Surface runoff [kg m**-2]"),
    /* 9 */ Parm("SSRO", "Sub-surface runoff [kg m**-2]"),
    ...
    /* 31 */ Parm("var31", "Fraction of sea-ice in sea [(0 - 1)]"),
    /* 32 */ Parm("var32", "undefined"),
    /* 33 */ Parm("var33", "undefined"),
    /* 34 */ Parm("var34", "Open-sea surface temperature [K]"),
    ...
    /* 83 */ Parm("var83", "Net primary productivity [kg C m**-2 s**-1]"),
    /* 84 */ Parm("var84", "undefined"),
    /* 85 */ Parm("var85", "10m U wind over land [m s**-1]"),
    /* 86 */ Parm("var86", "10m V wind over land [m s**-1]"),
    /* 87 */ Parm("var87", "1.5m temperature over land [K]"),
    /* 88 */ Parm("var88", "1.5m dewpoint temperature over land [K]"),
    /* 89 */ Parm("var89", "Top incoming solar radiation [W m**-2 s]"),
    /* 90 */ Parm("var90", "Top outgoing solar radiation [W m**-2 s]"),
    /* 91 */ Parm("var91", "undefined"),
    /* 92 */ Parm("var92", "undefined"),
    /* 93 */ Parm("var93", "undefined"),
    /* 94 */ Parm("var94", "Mean sea surface temperature [K]"),
    /* 95 */ Parm("var95", "1.5m specific humidity [kg kg**-1]"),
    /* 96 */ Parm("var96", "undefined"),
    /* 97 */ Parm("var97", "undefined"),
    /* 98 */ Parm("var98", "Sea-ice thickness [m]"),
    /* 99 */ Parm("var99", "Liquid water potential temperature [K]"),
    ...
    /* 110 */ Parm("var110", "Ocean ice concentration [(0 - 1)]"),
    /* 111 */ Parm("var111", "Ocean mean ice depth [m]"),
    ...
    /* 139 */ Parm("var139", "Soil temperature layer 1 [K]"),
    ...
    /* 167 */ Parm("var167", "1.5m temperature [K]"),
    /* 168 */ Parm("var168", "1.5m dewpoint temperature [K]"),
    /* 169 */ Parm("var169", "undefined"),
    /* 170 */ Parm("var170", "Soil temperature layer 2 [K]"),
    /* 171 */ Parm("var171", "undefined"),
    /* 172 */ Parm("var172", "Fractional land mask [(0 - 1)]"),
    /* 173 */ Parm("var173", "undefined"),
    /* 174 */ Parm("var174", "undefined"),
    /* 175 */ Parm("var175", "Average salinity in upper 293.4m [psu]"),
    ...
    /* 183 */ Parm("var183", "Soil temperature layer 3 [K]"),
    ...
    Parm(
        "var201",
        "1.5m temperature - maximum over last 24 hours [K]",
    ),
    /* 202 */
    Parm(
        "var202",
        "1.5m temperature - minimum over last 24 hours [K]",
    ),
    ...
    /* 236 */ Parm("var236", "Soil temperature layer 4 [K]"),
